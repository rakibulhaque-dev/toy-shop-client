...
const Stats = () => {
    return (
        <div class="bg-white py-24 sm:py-32 border container mx-auto mt-4 shadow-lg rounded-md">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    <h2 class="text-3xl font-bold tracking-tight text-secondary sm:text-4xl">From the blog</h2>
